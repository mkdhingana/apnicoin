...
const char     CRYPTONOTE_NAME[]                             = "apnicoin";
...
const int      P2P_DEFAULT_PORT                              = 23681;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 23682;
...
const std::initializer_list<const char*> SEED_NODES = {"45.63.107.239:23681",
